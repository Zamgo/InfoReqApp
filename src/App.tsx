...
const TRAINING_DOWNLOAD_FILES = [
  {
    name: "Kategorie_RVT.txt",
    path: "C:\\Users\\samuel.augustin\\Liftrock\\BIM Services - General\\07_Výstupy\\Škola BIM - Klee\\Prezentace\\Škola BIM 03_2026\\2 DEN\\Praktická část\\Kategorie_RVT.txt",
  },
  {
    name: "Klasifikace_CCI.txt",
    path: "C:\\Users\\samuel.augustin\\Liftrock\\BIM Services - General\\07_Výstupy\\Škola BIM - Klee\\Prezentace\\Škola BIM 03_2026\\2 DEN\\Praktická část\\Klasifikace_CCI.txt",
  },
  {
    name: "Klasifikace_ČAS.txt",
    path: "C:\\Users\\samuel.augustin\\Liftrock\\BIM Services - General\\07_Výstupy\\Škola BIM - Klee\\Prezentace\\Škola BIM 03_2026\\2 DEN\\Praktická část\\Klasifikace_ČAS.txt",
  },
  {
    name: "Příloha_A-1-a_Datový_standard_1.xlsx",
    path: "C:\\Users\\samuel.augustin\\Liftrock\\BIM Services - General\\07_Výstupy\\Škola BIM - Klee\\Prezentace\\Škola BIM 03_2026\\2 DEN\\Praktická část\\Příloha_A-1-a_Datový_standard_1.xlsx",
  },
] as const;

const toFileUri = (windowsPath: string): string => `file:///${windowsPath.replace(/\\/g, "/")}`;
...
const AppInner: React.FC<AppInnerProps> = ({ project, setProject }) => {
  ...
  const onDownloadTrainingFiles = useCallback(() => {
    TRAINING_DOWNLOAD_FILES.forEach((file, index) => {
      window.setTimeout(() => {
        const link = document.createElement("a");
        link.href = encodeURI(toFileUri(file.path));
    ...
    setStatus(`Spouštím stahování ${TRAINING_DOWNLOAD_FILES.length} souborů...`);
    setTimeout(() => setStatus(""), 4000);
  }, []);
      ...
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={onDownloadTrainingFiles}
            title="Stáhnout školní podklady"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
